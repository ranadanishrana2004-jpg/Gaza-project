      ...
      <Animated.View style={{ opacity:fadeAnim, transform:[{translateY:slideAnim}], alignItems:'center', zIndex:2, width:'100%' }}>
        ...
        <TouchableOpacity
          style={[styles.supportRibbon, {
            ...
            borderColor: isDark ? 'rgba(255,140,66,0.22)' : 'rgba(255,140,66,0.18)',
        ...
        <View style={[styles.supportPriorityGrid, isMobile && { flexDirection:'column' }]}>
          {priorities.map(item => (
            <View key={item.title} style={[styles.supportPriorityCard, {
              ...
              borderColor: isDark ? 'rgba(255,255,255,0.06)' : 'rgba(255,140,66,0.10)',
...
const styles = StyleSheet.create({
  ...
  supportRibbonIcon: { width:42, height:42, borderRadius:14, backgroundColor:ORANGE+'14', justifyContent:'center', alignItems:'center' },
  supportRibbonTitle: { fontSize:16, fontWeight:'800', marginBottom:4 },
  supportRibbonText: { fontSize:13, lineHeight:20 },
  supportRibbonAction: { flexDirection:'row', alignItems:'center', gap:8, backgroundColor:ORANGE, borderRadius:12, paddingHorizontal:16, paddingVertical:11, borderWidth:1, borderColor:'#E77828' },
  ...
  supportCampaignEyebrow: { color:ORANGE, fontSize:11, fontWeight:'800', letterSpacing:1.2, textTransform:'uppercase', marginBottom:10 },
  ...
  supportMiniStat: { minWidth:112, backgroundColor:ORANGE+'12', borderRadius:16, paddingHorizontal:14, paddingVertical:14, alignItems:'flex-start' },
  supportMiniValue: { color:ORANGE, fontSize:22, fontWeight:'900', marginBottom:4 },
  ...
  supportPriorityIcon: { width:44, height:44, borderRadius:14, justifyContent:'center', alignItems:'center', backgroundColor:ORANGE+'14', marginBottom:12 },
  ...
  supportPrimaryBtn: { flexDirection:'row', alignItems:'center', gap:8, backgroundColor:ORANGE, paddingHorizontal:22, paddingVertical:13, borderRadius:13, borderWidth:1, borderColor:'#E77828' },
