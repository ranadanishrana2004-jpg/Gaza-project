...
const s = StyleSheet.create({
  ...
  tabs: { flexDirection: 'row', borderRadius: 14, padding: 5, marginBottom: 22, gap: 4 },
  ...
  inputWrap: { flexDirection: 'row', alignItems: 'center', gap: 10, borderRadius: 14, borderWidth: 1, paddingHorizontal: 14, paddingVertical: 13, marginBottom: 14 },
