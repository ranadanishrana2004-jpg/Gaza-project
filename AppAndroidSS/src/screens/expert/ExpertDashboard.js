  ...
  return (
    ...
    >
      ...
      >
        ...
        <View style={styles.pageBanner}>
          <View style={styles.bannerLeft}>
            <View style={[styles.bannerIconCircle, { backgroundColor: `${theme.colors.success}18` }]}>
              <Icon name="grid" size={24} color={theme.colors.success} />
            </View>
            <View>
              <Text style={[styles.bannerTitle, { color: theme.colors.textPrimary }]}>Expert Dashboard</Text>
              <Text style={[styles.bannerSubtitle, { color: theme.colors.textSecondary }]}>
        ...
        <View style={styles.chartsSection}>
          ...
          <Animated.View entering={FadeInDown.duration(400).delay(100)} style={styles.chartCard}>
            <View style={[styles.coloredChartCard, { backgroundColor: theme.colors.heroGradientMid }]}>
            ...
            >
              <View style={styles.chartHeader}>
                <View style={styles.chartHeaderLeft}>
                  <View style={[styles.chartIconBadge, { backgroundColor: `${theme.colors.accent}18` }]}>
                    <Icon name="flash" size={16} color={theme.colors.accent} />
                  </View>
                  <View>
